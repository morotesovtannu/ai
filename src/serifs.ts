...
*/
	...
	noting: {
		notes: [
			...
			'はい、ママですよ〜',
			'くぅ～ん...',
			'Все ваши заметки принадлежат мне!',
			...
			'じー',
			'はにゃ？',
			'きぇぇぇぇぇぇぇ！:resonyance:\nウォウォウォウ:blobcatphoto: イェイェイェイ:blobcatPhotobomb:\nウォウウォウウォ:blobcatphoto: イェイイェイェ:blobcatPhotobomb:',
		],
		want: item => `${item}、欲しいなぁ...`,
		see: item => `お散歩していたら、道に${item}が落ちているのを見たんです！`,
		expire: item => `気づいたら、${item}の賞味期限が切れてました…`,
		broken: item => `なにもしていないのに、${item}が壊れちゃいました…`,
	},
};
